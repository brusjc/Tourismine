...
@section('contentheader_title')
	{{ html_entity_decode(trans('pagMaster.masterNuevo_title') )}}
@endsection
				...
				<form action="/masterPuntoNuevo2" method="POST" class="form-horizontal">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="ciudad_id" class="col-sm-2 control-label">{{trans('pagMaster.Ciudad')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="Nombre" class="col-sm-2 control-label">{{trans('pagMaster.Nombre')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="descripcion" class="col-sm-2 control-label">{{trans('pagMaster.Descripcion')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="leyenda" class="col-sm-2 control-label">{{trans('pagMaster.Leyenda')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="referencia" class="col-sm-2 control-label">{{trans('pagMaster.Referencia')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="telefono" class="col-sm-2 control-label">{{trans('pagMaster.Telefono')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="web" class="col-sm-2 control-label">{{trans('pagMaster.Web')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="longitud" class="col-sm-2 control-label">{{trans('pagMaster.Longitud')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="latitud" class="col-sm-2 control-label">{{trans('pagMaster.Latitud')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="coste" class="col-sm-2 control-label">{{trans('pagMaster.Coste')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="horario_id" class="col-sm-2 control-label">{{trans('pagMaster.Horario')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="tipo_id" class="col-sm-2 control-label">{{trans('pagMaster.Tipo')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="puntos" class="col-sm-2 control-label">{{trans('pagMaster.Puntos')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="siglo" class="col-sm-2 control-label">{{trans('pagMaster.Siglos')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="etiquetas" class="col-sm-2 control-label">{{trans('pagMaster.Etiquetas')}}</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label for="curiosidades" class="col-sm-2 control-label">{{trans('pagMaster.Curiosidades')}}</label>
							<div class="col-sm-7">
